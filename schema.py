...
RefreshToken = Annotated[str, StringConstraints(pattern=r'^[A-Za-z0-9-_=]+\.[A-Za-z0-9-_=]+\.?[A-Za-z0-9-_.+/=]*$')]
AccessToken = Annotated[str, StringConstraints(max_length=256, pattern=r'^(?:[0-9a-fA-F]{2})+$')]
